...
class Section3:
    ...
    def partD(
        ...
        answer = {
            ...
            'explain_purpose_of_class_weights': "Class weights are employed to assign higher importance to underrepresented classes during classifier training. This approach is beneficial in addressing bias towards the majority class within imbalanced datasets, with the goal of enhancing the classifier's performance specifically on the minority class.",
            'explain_performance_difference': "Employing class weights has the potential to enhance recall for the minority class but may come at the cost of precision. This is because the classifier is incentivized to accurately classify instances of the minority class, which could lead to an increase in false positives."
        }
        print(answer)
        return answer
